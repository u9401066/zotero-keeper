...
def _month_to_number(month: str) -> str | None:
...
def extract_pmid_from_zotero_item(item: dict[str, Any]) -> str | None:
    """
...
def extract_doi_from_zotero_item(item: dict[str, Any]) -> str | None:
