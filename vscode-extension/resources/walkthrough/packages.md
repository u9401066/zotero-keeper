...
uv pip install --upgrade --force-reinstall --python <extension-storage>/venv/bin/python \
  "zotero-keeper @ https://github.com/u9401066/zotero-keeper/archive/refs/tags/v0.9.1-ext.tar.gz#subdirectory=mcp-server" \
  "pubmed-search-mcp @ https://github.com/u9401066/pubmed-search-mcp/archive/fbbaacaba150afbc24bdbc07eb41c77c564017e6.tar.gz"
```
